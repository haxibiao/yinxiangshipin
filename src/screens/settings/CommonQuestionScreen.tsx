...
export default function CommonQuestionScreen(props: any) {
                        ...
                        return (
                            <View style={styles.issueItem} key={index}>
                                <View style={styles.question}>
                                    <Image
                                        style={styles.avatar}
                                        source={require('@app/assets/images/avatar_man.png')}
                                    />
                                ...
                                <View style={styles.answer}>
                                    ...
                                    <Image
                                        style={styles.avatar}
                                        source={require('@app/assets/images/avatar_women.png')}
                                    />
                                </View>
                            </View>
                        );
