                ...
                <View style={{ paddingHorizontal: 15, paddingVertical: 20 }}>
                    ...
                    <View style={styles.fontWrap}>
                        <Text style={styles.tintFont}>
                            {Config.AppName}
                            运营和开发团队（以下简称“我们”或“公司”）深知个人信息安全的重要性,我们将按照法律法规的规定,采用安全保护措施,保护您的个人信息及隐私安全。因此,我们制定《
                            {Config.AppName}
                    ...
                    <View style={styles.fontWrap}>
                        <Text style={styles.tintFont}>1.当您遇到问题，可以通过http://jinlinle.com/ 与我们联系。</Text>
                    </View>
                    <View style={styles.fontWrap}>
                        <Text style={styles.tintFont}>
                    ...
                    <View style={styles.fontWrap}>
                        <Text style={styles.tintFont}>
                            3.公司名称:近邻乐（深圳）有限责任公司 注册地址:深圳市罗湖区莲塘街道罗沙路 2098 号畔山花园
                            13-804 联系电话: 17692625821
                        </Text>
                    </View>
                </View>
            </ScrollView>
