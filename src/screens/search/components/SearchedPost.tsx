...
const index = observer(({ keyword }) => {
    const { loading, error, data, fetchMore, refetch } = useQuery(GQL.searchPostQuery, {
        variables: { query: keyword, type: 'POST', page: 1 },
    });
    let articles = useMemo(() => Helper.syncGetter('searchPosts.data', data), [data]);
    if (Array.isArray(articles)) {
        articles = observable(articles);
    }
    const currentPage = useMemo(() => Helper.syncGetter('searchPosts.paginatorInfo.currentPage', data) || 1, [data]);
    const hasMorePages = useMemo(() => Helper.syncGetter('searchPosts.paginatorInfo.hasMorePages', data), [data]);
            ...
            fetchMore({
                ...
                updateQuery: (prev: any, { fetchMoreResult }) => {
                    ...
                    return Object.assign({}, prev, {
                        searchPosts: Object.assign({}, fetchMoreResult.searchPosts, {
